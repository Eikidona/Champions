...
public class ModDamageTypes {
  public static final ResourceKey<DamageType> REFLECTION_DAMAGE = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Champions.MODID, "reflection"));
  public static final ResourceKey<DamageType> CINDER_BULLET = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(Champions.MODID, "cinder_bullet"));
