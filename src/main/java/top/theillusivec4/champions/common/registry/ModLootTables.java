...
public class ModLootTables {
  ...
  public static final ResourceKey<LootTable> EMPTY = register(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(Champions.MODID, "empty")));
